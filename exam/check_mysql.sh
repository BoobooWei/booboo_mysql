...
function check2 {
	echo "check mysql-proxy"
	ssh root@172.25.$1.15 "ps -ef|grep mysql" | grep "\-P.*\-s"  &> /dev/null && print_SUCCESS || print_FAIL 20
